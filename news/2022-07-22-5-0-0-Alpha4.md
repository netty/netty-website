...
We are happy to announce the forth Alpha release of the upcoming netty 5.0.0. This release removes a lot of code-duplication and API cleanup. Beside this it also adds support for Unix Domain Sockets when using the JDK NIO implementation. 
